...
const content = {
  en: {
    hero: {
      ...
      headline4: "clear",
      sub: "Principal product designer for developer tools and complex enterprise systems. I help teams build things that are as understandable as they are powerful, and create the design foundations that scale with them.",
      cta1: "See my work",
      cta2: "Get in contact",
    },
  ...
  de: {
    hero: {
      ...
      sub: "Principal Product Designer für Developer-Tools und komplexe Enterprise-Systeme. Ich helfe Teams, Dinge zu bauen, die so verständlich sind wie sie leistungsfähig sind, und schaffe die Design-Grundlagen, die mit ihnen skalieren.",
      cta1: "Meine Arbeiten",
