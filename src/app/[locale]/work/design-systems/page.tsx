    ...
    >
      {de ? (
        <>
          ...
          <CaseStudyImage wide src="/case-studies/design-systems/design-systems-nine-repos-problem.png" alt="Das Nine-Repos-Problem bei Sygnum — neun Teams, die unabhängig voneinander bauen" />
          ...
          <CaseStudyImage wide src="/case-studies/design-systems/design-systems-tokens.png" alt="Design-System-Tokens bei Aerospike — Farb-, Typografie- und Abstands-Tokens in der Praxis" />
          ...
          <CaseStudyImage wide src="/case-studies/design-systems/design-systems-figma-code-ai-connected-loop.png" alt="Figma, Code und KI-Tools in einem verbundenen Loop bei Aerospike" />
          ...
          <CaseStudyImage wide src="/case-studies/design-systems/design-systems-ai-agent-skills.png" alt="KI-Agent-Skills, die auf der Design-System-Dokumentation basieren — Claude und Cursor folgen denselben Regeln wie das Team" />
        ...
        <>
          ...
          <CaseStudyImage wide src="/case-studies/design-systems/design-systems-nine-repos-problem.png" alt="The nine repos problem at Sygnum — nine teams building independently with no shared foundation" />
          ...
          <CaseStudyImage wide src="/case-studies/design-systems/design-systems-tokens.png" alt="Design system tokens at Aerospike — colour, typography and spacing tokens in practice" />
          ...
          <CaseStudyImage wide src="/case-studies/design-systems/design-systems-figma-code-ai-connected-loop.png" alt="Figma, code and AI tools in a connected loop at Aerospike" />
          ...
          <CaseStudyImage wide src="/case-studies/design-systems/design-systems-ai-agent-skills.png" alt="AI agent skills built on design system documentation — Claude and Cursor following the same rules as the team" />
