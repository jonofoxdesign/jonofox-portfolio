      ...
      {de ? (
        <>
          ...
          <div className="my-12 w-full rounded-2xl overflow-hidden border border-surface-muted">
            <img src="/case-studies/goodlife/user-reviews-before.png" alt="Kundenbewertungen — häufige Beschwerden über Bindungsangst und unklare Vertragsbedingungen" className="w-full h-auto" />
          </div>
          <div className="my-12 w-full rounded-2xl overflow-hidden border border-surface-muted">
            <img src="/case-studies/goodlife/old-flow-mockup.png" alt="Alter Anmeldeflow — komplexe Konfiguration ohne Preistransparenz" className="w-full h-auto" />
          </div>
          <div className="my-12 w-full rounded-2xl overflow-hidden border border-surface-muted"><img src="/case-studies/goodlife/config-complexity.svg" alt="Configuration complexity" className="w-full h-auto" /></div>
          ...
          <div className="my-12 w-full rounded-2xl overflow-hidden border border-surface-muted"><img src="/case-studies/goodlife/progressive-config.svg" alt="Progressive configuration" className="w-full h-auto" /></div>
          <div className="my-12 grid grid-cols-2 gap-4">
            <div className="rounded-2xl overflow-hidden border border-surface-muted">
              <img src="/case-studies/goodlife/hero-redesigned-flow.png" alt="Neu gestalteter Anmeldeflow — 12-Monats-Auswahl mit Live-Zusammenfassung" className="w-full h-auto" />
            </div>
            <div className="rounded-2xl overflow-hidden border border-surface-muted">
              <img src="/case-studies/goodlife/redesigned-flow-3months.png" alt="Neu gestalteter Anmeldeflow — 3-Monats-Auswahl mit aktualisierter Preisgestaltung" className="w-full h-auto" />
            </div>
          </div>
        ...
        <>
          ...
          <div className="my-12 w-full rounded-2xl overflow-hidden border border-surface-muted">
            <img src="/case-studies/goodlife/user-reviews-before.png" alt="Customer reviews — widespread complaints about lock-in anxiety and unclear contract terms" className="w-full h-auto" />
          </div>
          <div className="my-12 w-full rounded-2xl overflow-hidden border border-surface-muted">
            <img src="/case-studies/goodlife/old-flow-mockup.png" alt="Old sign-up flow — complex configuration without pricing transparency" className="w-full h-auto" />
          </div>
          <div className="my-12 w-full rounded-2xl overflow-hidden border border-surface-muted"><img src="/case-studies/goodlife/config-complexity.svg" alt="Configuration complexity" className="w-full h-auto" /></div>
          ...
          <div className="my-12 grid grid-cols-2 gap-4">
            <div className="rounded-2xl overflow-hidden border border-surface-muted">
              <img src="/case-studies/goodlife/hero-redesigned-flow.png" alt="Redesigned sign-up flow — 12-month selection with live summary panel" className="w-full h-auto" />
            </div>
            <div className="rounded-2xl overflow-hidden border border-surface-muted">
              <img src="/case-studies/goodlife/redesigned-flow-3months.png" alt="Redesigned sign-up flow — 3-month selection showing updated pricing" className="w-full h-auto" />
            </div>
          </div>
